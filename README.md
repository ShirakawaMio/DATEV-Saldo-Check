...
- die Umsatzsumme dieses Gegenkontos pro Datei.
...
Bei der Auswahl eines Ordners oder ZIP-Archivs werden unter den Einzelergebnissen
zusätzlich die Summe aller erfolgreich berechneten Saldo und die gesamte
Umsatzsumme des ausgewählten Gegenkontos angezeigt. `0.00 EUR` beim Saldo
bedeutet `OK`, ein anderer Saldo bedeutet `FEHLER`.
